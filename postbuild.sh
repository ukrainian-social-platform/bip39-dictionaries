...
{
	"name": "@ukrainian-social-platform/bip39-dictionaries",
	"version": "${1:1}",
	"type": "module",
	"private": false,
	"main": "index.cjs",
	"module": "index.js",
	"license": "MIT",
	"description": "Prebuilt BIP39 dictionaries (standard + some additional)",
	"repository": "github:ukrainian-social-platform/bip39-dictionaries",
	"engines" : {
		"node" : ">=18.0.0"
	}
}
